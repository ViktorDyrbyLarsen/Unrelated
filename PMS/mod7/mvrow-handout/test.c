...
int main(void)
{
    ...
    */
    ...
    // Compute y = A*x
    printf("Testing my_dgemv_v1() with valid inputs...\n");    
    if (my_dgemv_v1(2.0, 3.0, &A, &x, &y) != 0)
    {
    ...
    printf("Testing my_dgemv_v1() with invalid inputs...\n");
    if (my_dgemv_v1(2.0, 3.0, NULL, &x, &y)!=1  ||  my_dgemv_v1(2.0, 3.0, &A, NULL, &y)!=1  ||  my_dgemv_v1(2.0, 3.0, &A, &x, NULL)!=1 ) {
